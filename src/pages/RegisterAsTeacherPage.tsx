		...
		<div className='mt-[80px]'>
			...
			>
				<div className='relative flex items-center justify-between'>
					...
					/>
					<div className='z-10 absolute pl-40'>
						...
						<div className='flex justify-between'>
							<div className='flex flex-col items-center'>
								...
								<div className='text-center px-12 font-normal'>
									Сами выбирайте курсы для публикации так, как вам захочется, а
									также сохраняйте полный контроль над своими материалами.
								</div>
							</div>
							<div className='flex flex-col items-center'>
					...
					<div className='mb-12'>
						...
						>
							{navButtons?.map(item => (
								<div
									key={item.id}
									className={item.title == card ? 'shadow-[0_2px_0_black]' : ''}
						...
						<div className='here-to-help--text--2wJxn'>
							<div>
								...
								<p className='text-center text-[19px]'>
									Наша <strong>команда поддержки преподавателей</strong> всегда
									готова ответить на любые вопросы и проверить ваше тестовое
									видео, а наш <strong>Teaching Center</strong> предоставляет
									доступ к множеству ресурсов, которые могут облегчить вашу
									задачу. Также вы можете заручиться поддержкой опытных
									преподавателей в нашем <strong>интернет-сообществе</strong>.
								</p>
								{/* <a
				...
				<div className='flex justify-center bg-stone-100 py-32'>
					<div className='flex flex-col items-center gap-y-10'>
						...
						>
							<span className='bg-black px-16 py-3 text-white font-bold rounded-xl'>
								Начните действовать
							</span>
						</button>
					</div>
